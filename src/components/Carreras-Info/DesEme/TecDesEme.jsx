    ...
    <div className="carreras-info-container">
      <div className="section-carreras-info">
        <div className="overlay-carreras container-fluid">
          <h1 className="title-carreras text-fluid">
            TECNICATURA UNIVERSITARIA EN DESASTRES Y EMERGENCIAS SANITARIAS
          </h1>
        </div>
      </div>
        ...
        <div className="container">
          <div className="intro-content">
            ...
            <div className="intro-text">
              Frente al aumento de eventos críticos como catástrofes naturales, emergencias sanitarias o
              crisis humanitarias, <strong>se necesitan profesionales especializados</strong> en su prevención, 
              mitigación y respuesta. Esta tecnicatura te forma para actuar <strong>eficazmente en situaciones que
              requieren acción rápida, coordinación y sensibilidad social.</strong>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="objective-section">
        <div className="container">
          <p className="objective-text">
            Formar técnicos/as con capacidades para <strong>planificar, ejecutar y evaluar acciones</strong>
            de forma coordinada y eficiente ante situaciones críticas para <strong>proteger la salud
            ...
            <div className="col-md-6 col-lg-3 mb-4">
              <div className="info-card">
                ...
                <div className="info-value">
                  Técnico/a Universitario/a en Desastres y Emergencias Sanitarias
                </div>
              </div>
            </div>
